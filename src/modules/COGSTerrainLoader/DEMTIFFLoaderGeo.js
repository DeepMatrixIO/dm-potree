/**
 * Loader for reading extracting xyz values from a TIFF file and create a grid.
 */
import {
	BufferGeometry,
	FileLoader,
...
var DEMTIFFLoaderGeo = (function () {
	...
	function DEMTIFFLoaderGeoConstructor(manager) {

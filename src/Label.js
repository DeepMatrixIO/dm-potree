...
//todo modify it
export class Label extends EventDispatcher {
	constructor(args = {}) {
		super();
		...
		this.domElement = $(`
			<div class="annotation" oncontextmenu="return false;">
				<div class="annotation-titlebar">
					...
					<span class="annotation-label-close">
		...
		*/
		...
		this.elLabelClose = this.elTitlebar.find('.annotation-label-close');
		...
		/*
		this.elLabelClose.hover(
			e => this.elLabelClose.css('opacity', '1'),
			e => this.elLabelClose.css('opacity', '0.5')
		);
		*/
		...
		this.elLabelClose.click(
			function (e) {
				//this.setHighlighted(true)
				console.log('Close Button')
				this.remove(this.domElement)
			}
